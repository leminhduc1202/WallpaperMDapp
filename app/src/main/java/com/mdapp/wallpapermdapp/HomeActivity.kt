...
import com.mdapp.wallpapermdapp.adapter.Adapter
...
class HomeActivity : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    private fun setDataList(): ArrayList<Items> {
        ...
        arrayList.add(Items(R.drawable.barbarian, "Barbarian","BARBARIAN\n" +
        ...
        arrayList.add(Items(R.drawable.amazon, "Amazon", "AMAZON\n" +
        ...
        arrayList.add(Items(R.drawable.druid, "Druid","DRUID\n" +
        ...
        arrayList.add(Items(R.drawable.assassin, "Assassin", "ASSASSIN\n" +
        ...
        arrayList.add(Items(R.drawable.necromancer, "Necromancer", "NECROMANCER\n" +
        ...
        arrayList.add(Items(R.drawable.sorceress, "Sorceress","SORCERESS\n" +
    ...
    override fun onItemClick(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
        ...
        Toast.makeText(applicationContext, itemss.name, Toast.LENGTH_LONG).show()
